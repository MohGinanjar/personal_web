            ...
            child: Padding(
              ...
              child: Column(
                ...
                Padding(
                  ...
                  child: Text("Pendidikan",style: TextStyle(fontSize: 30),),
                ),
                 SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                          height: MediaQuery.of(context).size.height / 35),
                          Text("mulai mengembangkan skill di jenjang Universitas, sampai sekarang")
                        ],
                      ),
                    ),
                  ),
          ...
          Container(
            ...
            child:  Padding(
              ...
              child: Column(
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("Pengalaman",style: TextStyle(fontSize: 30),),
                ),
                 SizedBox(
                  height: MediaQuery.of(context).size.height * 0.1,
                ),
